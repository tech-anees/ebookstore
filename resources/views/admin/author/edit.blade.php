...
<section class="content">
  ...
  <div class="box box-primary">
      ...
      <div class="row"> 
            ...
            <div class="col-xs-6">
               <div class="form-group">
                ...
                <div class="form-group">
                  <img src="/uploads/{{ $author->author_img }}" id="showImage" width="60" height="60" class="rounded avatar-lg" alt="No image found">
                </div>
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="twitter_id" class="form-control" id="twitter_id" placeholder="Twitter ID" value="{{ $author->twitter_id }}" value="{{ $author->title }}">
                </div>
    ...
    <div class="box-footer">
        ...
        <a href="{{ route('author.index') }}" type="reset" class="btn btn-danger">Cancel</a>
      </div>
  </div>
      <!-- /.box -->
      </form>

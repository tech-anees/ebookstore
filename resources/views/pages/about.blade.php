                        ...
                        <div class="team-column">
                            <div class="team-img">
                                @if($team->team_img == 'No image found')
                                    <img src="/uploads/no-img.jpg" width="263" height="253" alt="No image found">
                                @else
                                    <img src="/uploads/{{ $team->team_img }}" width="263" height="253" alt="{{ $team->fullname }}">
                                @endif
                            ...
                            <div class="team-btm">
                                <ul class="social-icons"> 
                                    <li><a class="facebook" href="{{ $team->facebook_id }}"><i class="fa fa-facebook"></i></a></li>
                                    <li><a class="twitter" href="{{ $team->twitter_id }}"><i class="fa fa-twitter"></i></a></li>
                                    <li><a class="pinterest" href="{{ $team->pinterest_id }}"><i class="fa fa-pinterest-p"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
